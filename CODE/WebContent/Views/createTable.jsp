...
<% try{
	  ...
	  Statement stmt=con.createStatement();
		 ...
		 String CREATE_TABLE_EMPLOYEE="CREATE TABLE Employee ("+
  			...
  			+ "PRIMARY KEY ( Emp_id ), "
  			+"FOREIGN KEY (Emp_Branch_Code) REFERENCES BranchDetails(Branch_IFSC))";
		 ...
		 String CREATE_TABLE_ACCOUNT="CREATE TABLE Account ("+
      			...
      			+"FOREIGN KEY (Am_Cust_No) REFERENCES Customer(Cust_Num))";
		 String CREATE_TABLE_TRANSACTION="CREATE TABLE Transaction ("+
      			...
      			+"PRIMARY KEY (Tran_No),"
      			+"FOREIGN KEY (Tran_Sender_Account_No) REFERENCES Account(Am_Cust_Account_No))";
		 ...
		 String CREATE_TABLE_INTERNETUSER="CREATE TABLE InternetDetails ("+
				 ...
				 +"PRIMARY KEY (ID_Num),"
				   +"FOREIGN KEY (ID_Cust_Num) REFERENCES Customer(Cust_Num))";
