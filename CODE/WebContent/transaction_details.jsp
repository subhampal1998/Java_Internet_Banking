						...
						<div class="row">
							<div class="col-md-10 ">
								...
								<% 
									...
									try{
									  	list=(ArrayList)request.getAttribute("data");
									...
									<tr>
										...
										<td><%out.print(list.get(i+1)); %></td>
										<td><%out.print(list.get(i+2)); %></td>
										<td><%out.print(list.get(i+3)); %></td>
										<td><%out.print(list.get(i+4)); %></td>
										<td><%out.print(list.get(i+5)); %></td>
										<td><%out.print(list.get(i+6)); %></td>
									</tr>
										<% }
									  }}
									  catch(Exception e)
